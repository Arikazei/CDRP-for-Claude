#!/usr/bin/env bash
# Packt das Diagnoseprogramm zu einer einzelnen ausfuehrbaren Datei.
# Ergebnis: dist/atspi-dump, laeuft ohne pip und ohne Installation.
#
...
# Voraussetzung auf dem Zielrechner ist damit nur python3.
set -euo pipefail
...
cp "$wurzel/linuxdesktop.py" "$bau/linuxdesktop.py"
